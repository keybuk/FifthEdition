...
struct BookCodableTests {
    ...
    func `Book with required fields`() throws {
        try testCodable(
            ...
            """,
            value: Book(name: "Player's Handbook",
                        id: "PHB",
                        source: "PHB",
                        group: .core,
    ...
    func `Book with standard fields`() throws {
        try testCodable(
            ...
            """,
            value: Book(name: "Dungeon Master's Guide (2024)",
                        id: "XDMG",
                        source: "XDMG",
                        group: .core,
                        published: #require(DateComponents(calendar: Calendar(identifier: .iso8601),
    ...
    func `Book with alias and parentSource`() throws {
        try testCodable(
            ...
            """,
            value: Book(name: "Sigil and the Outlands",
    ...
    func `Book with revised date`() throws {
        try testCodable(
            ...
            """,
            value: Book(name: "Sage Advice Compendium (2025)",
                        id: "XSAC",
                        source: "XSAC",
                        group: .other,
                        published: #require(DateComponents(calendar: Calendar(identifier: .iso8601),
...
struct BookGroupCodableTests {
    ...
    func `book groups`(bookGroup: Book.Group) throws {
        try testCodable(
            json: """
            "\(bookGroup.rawValue)"
            """,
