...
struct CreatureCodableTests {
    ...
    func `Creature encodes typical fields`() throws {
        try testCodable(
            ...
            value: Creature(name: "Evil Monkey",
                            ...
                            alignment: Creature.Alignments(.chaoticEvil),
                            armorClass: [.ac(20)],
    ...
    @Test
    func `Creature encodes alignment prefix in alignment`() throws {
        try testCodable(
            json: """
            {
                "name": "Gremlin",
            ...
            value: Creature(name: "Gremlin",
                            ...
                            size: Creature.Sizes(.small),
                            type: Creature.Types(.monstrosity),
                            alignment: Creature.Alignments([.chaoticEvil], prefix: "Typically ")),
        )
    }
