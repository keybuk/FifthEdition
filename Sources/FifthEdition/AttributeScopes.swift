...
extension AttributeScopes {
    struct FifthEditionAttributes: AttributeScope {
        struct CreatureAttributes: AttributeScope {
            ...
            enum AlignmentsAttribute: AttributedStringKey {
                typealias Value = Creature.Alignments
                static let name = "Creature.Alignments"
            }
            ...
            enum ResourcesAttribute: AttributedStringKey {
                typealias Value = Creature.Resources
                static let name = "Creature.Resources"
            }
        ...
        enum ResourceAttribute: AttributedStringKey {
            typealias Value = Resource
            static let name = "Resource"
        }
        ...
        let resource: ResourceAttribute
        let sense: SenseAttribute
