...
extension Creature: Codable {
    enum CodingKeys: String, CodingKey {
        ...
        // DONE
        case page
        case canBeFamiliar = "familiar" // TODO: null
        ...
        case tokenHref
        case isNamedCreature // TODO: null
        case isNPC // TODO: null
    ...
    public init(from decoder: any Decoder) throws {
        ...
        alignment = try container.decodeIfPresent(Alignments.self, forKey: .alignment) ?? []
        ...
        externalSources = try container.decodeIfPresent([Entry].self, forKey: .externalSources) ?? []
    ...
    public func encode(to encoder: any Encoder) throws {
        ...
        try container.encodeIfPresent(!externalSources.isEmpty ? externalSources : nil, forKey: .externalSources)
        try container.encodeIfPresent(!resources.isEmpty ? resources : nil, forKey: .resources)
